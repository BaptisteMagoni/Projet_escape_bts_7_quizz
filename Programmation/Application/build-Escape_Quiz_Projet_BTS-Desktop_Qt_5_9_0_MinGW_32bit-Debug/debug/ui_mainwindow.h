...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        button_send_data = new QPushButton(ZoneBouton);
        button_send_data->setObjectName(QStringLiteral("button_send_data"));

        horizontalLayout_3->addWidget(button_send_data);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        button_send_data->setText(QApplication::translate("MainWindow", "Send Data !", 0));
    } // retranslateUi
